...
function deleteCommentByname(name,blog_id,success) {
    var deleteSql = "delete from comments where user_name = " + "\""+name+"\"" + " and blog_id = " + blog_id + " or parent_name=" + "\""+name+"\"";
...
function deleteCommentBynameAndContent(name,blog_id,comment,success) {
    var deleteSql = "delete from comments where user_name = " + "\""+name+"\"" + " and blog_id = " + blog_id  + " and comments = " +"\"" +comment+"\"" + " or parent_name=" + "\""+name+"\"";
    console.log(deleteSql)
    var connection = dbutil.createConnection();
    connection.connect();
    connection.query(deleteSql,function (error,result) {
...
module.exports.deleteCommentByname = deleteCommentByname;
module.exports.deleteCommentBynameAndContent = deleteCommentBynameAndContent;
